...
import mx.kinich49.expensetracker.validations.validators.commercialestablishmentservice.CommercialEstablishmentRequestValidatorImpl;
...
public class CommercialEstablishmentRequestValidatorTest {
    ...
    @InjectMocks
    CommercialEstablishmentRequestValidatorImpl subject;
    ...
    void shouldNotThrowException_whenRequestIsValid() throws ValidationFlowException {
        ...
        var parameter = new CommercialEstablishmentRequestValidatorImpl.Parameter(request);
    ...
    void shouldThrowException_whenRequestIsNull() throws ValidationFlowException {
        //given
        var parameter = new CommercialEstablishmentRequestValidatorImpl.Parameter(null);
