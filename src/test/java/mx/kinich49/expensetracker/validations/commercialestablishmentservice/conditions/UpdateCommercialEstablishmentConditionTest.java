...
public class UpdateCommercialEstablishmentConditionTest {
    ...
    @InjectMocks
    UpdateCommercialEstablishmentCondition subject;
    ...
    void shouldReturnError_whenIdIsNotValid(Long id) {
        ...
        var errorWrapper = result.get();

        assertEquals(CommercialEstablishmentServiceErrorCodes.INVALID_ID, errorWrapper.getErrorCode());
    ...
    void shouldReturnError_whenIdIsNotExistent(Long id) {
        ...
        assertEquals(CommercialEstablishmentServiceErrorCodes.COMMERCIAL_ESTABLISHMENT_WITH_ID_DOES_NOT_EXISTS, errorWrapper.getErrorCode());
    }
